                    ...
                    <div class="card-tools">
                        <form class="form-inline" method="GET">
                            <select name="category" class="form-control form-control-sm mr-2" onchange="this.form.submit()">
                                ...
                                <option value="<?php echo $cat['category']; ?>" <?php echo ($current_category == $cat['category']) ? 'selected' : ''; ?>>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr class="<?php echo ($item['stock'] == 0) ? 'out-of-stock' : (($item['stock'] <= 10) ? 'low-stock' : ''); ?>">
                                ...
                                <td>
                                    <a href="<?php echo BASE_URL; ?>/menu/edit/<?php echo $item['menu_id']; ?>" class="btn btn-sm btn-warning">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="<?php echo BASE_URL; ?>/menu/delete/<?php echo $item['menu_id']; ?>" class="btn btn-sm btn-danger delete-btn">
